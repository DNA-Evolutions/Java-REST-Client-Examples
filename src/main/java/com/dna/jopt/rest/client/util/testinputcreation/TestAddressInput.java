...
public final class TestAddressInput {
	...
	adds.add(new GeoAddress().city("D�sseldorf").streetname("K�nigsallee").housenumber("71").postalcode("40215")
		.locationId("Duessldorf Location"));

	adds.add(new GeoAddress().city("K�ln").postalcode("50667").locationId("Cologne Location"));

	adds.add(new GeoAddress().city("Essen").streetname("Kreuzeskirchstra�e").housenumber("25").postalcode("45127")
		.locationId("Essen Location"));

	adds.add(new GeoAddress().city("D�sseldorf").streetname("Rollandstra�e").locationId("Duessldorf Location 2"));

	adds.add(new GeoAddress().city("Wuppertal").streetname("Herzogstra�e").locationId("Wuppertal Location"));
	...
	adds.add(new GeoAddress().city("Aachen").streetname("Mauerstra�e").locationId("Aachen Location"));
	...
	adds.add(new GeoAddress().city("Bonn").streetname("Dorotheenstra�e").housenumber("135").postalcode("53111")
